...
export const LAYERS: LayerDef[] = [
  ...
  { id: 'dot_potholes', label: 'Office DOT Potholes (Verified)', indicator: { type: 'icon', code: 'DOT' }, ranked: false, rankColumn: null, delivery: 'geojson', file: 'dot-office-potholes.geojson', geometry: 'point' },
