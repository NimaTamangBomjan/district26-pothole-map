<!-- Figma Link arrow (node 15:148), exact paths. The "Github" affordance — an
     external-link arrow, NOT a GitHub logo. Recolored via currentColor. -->
<svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true">
  <path d="M8.125 1.625H11.375V4.875" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M5.41667 7.58333L11.375 1.625" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
  <path
